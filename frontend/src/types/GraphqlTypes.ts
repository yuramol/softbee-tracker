...
export type GenericMorph = ComponentProjectSalary | I18NLocale | Note | Project | Tracker | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
